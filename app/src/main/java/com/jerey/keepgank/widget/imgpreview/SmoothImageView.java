package com.jerey.keepgank.widget.imgpreview;
...
public class SmoothImageView extends PhotoView {
    ...
    /** remember the location of enter pic */
        ...
        if (getScale() == 1) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    // 水平方向移动不予处理
                    if (!isMoved && (Math.abs(offsetX) > Math.abs(offsetY) || Math.abs(offsetY) <
                            MIN_TRANS_DEST)) {
    ...
    private void startTransform() {
        ...
        if (mStatus == Status.STATE_IN) {
            ...
            PropertyValuesHolder widthHolder = PropertyValuesHolder.ofFloat("animWidth",
                                                                            startTransform.width,
                                                                            endTransform.width);
            PropertyValuesHolder heightHolder = PropertyValuesHolder.ofFloat("animHeight",
                                                                             startTransform
                                                                                     .height,
                                                                             endTransform.height);
            animator.setValues(scaleHolder, alphaHolder, leftHolder, topHolder, widthHolder,
                               heightHolder);
            ...
            PropertyValuesHolder leftHolder = PropertyValuesHolder.ofFloat("animLeft",
                                                                           endTransform.left,
                                                                           startTransform.left);
            PropertyValuesHolder topHolder = PropertyValuesHolder.ofFloat("animTop", endTransform
                    .top, startTransform.top);
            PropertyValuesHolder widthHolder = PropertyValuesHolder.ofFloat("animWidth",
                                                                            endTransform.width,
                                                                            startTransform.width);
            PropertyValuesHolder heightHolder = PropertyValuesHolder.ofFloat("animHeight",
                                                                             endTransform.height,
                                                                             startTransform.height);
            animator.setValues(scaleHolder, alphaHolder, leftHolder, topHolder, widthHolder,
                               heightHolder);
        }
    ...
    private void initTransform() {
        ...
        if (getDrawable() instanceof BitmapDrawable) {
            ...
            Bitmap mBitmap = Bitmap.createBitmap(getDrawable().getIntrinsicWidth(),
                                                 getDrawable().getIntrinsicHeight(), Bitmap
                                                         .Config.RGB_565);
            bitmapWidth = mBitmap.getWidth();
            bitmapHeight = mBitmap.getHeight();
        }
    ...
    public static int getStatusBarHeight(Context context) {
        int statusBarHeight = context.getResources().getDimensionPixelSize(R.dimen.dimen_25dp);
        try {
